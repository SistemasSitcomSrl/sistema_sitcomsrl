<div>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 class="py-1 text-lg font-bold leading-tight tracking-tight text-dark-900 md:text-2xl dark:text-dark">
            Lista de Transferencia de Herramientas Enviadas
        </h2>
        <x-table>
                ...
                <table class="table-fixed min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50 sticky top-0">
                        <tr>
                            ...
                            @php
                                $can =
                                    Gate::allows('admin.transfer-sent.see') || Gate::allows('admin.transfer-sent.pdf');
                            @endphp
                            @if ($can)
                                <th scope="col"
                                    class="px-1 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($movements as $movement)
                            <tr wire:key="movement-{{ $movement->receipt_number }}">
                                ...
                                @endif
                                <td class=" pt-1 flex text-center"
                                    style="padding-top: 0.150rem;   padding-bottom: 0.150rem;">
                                    @can('admin.transfer-sent.see')
                                        <div class="text-center">
                                            @livewire('transferenciaEnviadas.view-transfers-sent', ['receipt_number' => $movement->receipt_number], key($movement->receipt_number))
                                        </div>
                                    @endcan
