        ...
        <div class="p-2 border-4  border-slate-200 w-7/12">
            ...
            <div>
                <p class="w-full text-xs text-center font-bold py-1 align-middle m-0">
                    REPORTE DE TRANSFERENCIA DE HERRAMIENTAS</p>
            </div>
            <div class="w-full">
            ...
            <div class="pb-2 text-sm">
                @foreach ($names as $name)
                    <div class=" border-x-4 border-t border-slate-700 grid grid-cols-12 divide-x">
                        ...
                        <div class="col-span-4">{{ $name->name_user }}</div>
                        <div class="text-right pr-2 font-bold">Ciudad:</div>
                        <div class="col-span-3">{{ $name->department }}</div>
                    ...
                    <div class=" border-x-4 border-t border-b border-slate-700 grid grid-cols-12 divide-x">
                        <div class="pr-2 text-right font-bold">Sucursal:</div>
                        <div class="col-span-4">{{ $name->name }}</div>

                        <div class="text-right pr-2 font-bold">Celular:</div>
                        <div class="col-span-3">{{ $name->number_phone }}</div>
                    </div>
                @endforeach
            </div>
            ...
            <div class="w-full">
                <button type="button"
                    ...
                    DATOS DEL RESPONSABLE DE LA TRANSFERENCIA DE EQUIPOS
                </button>
            </div>
            ...
            <div class="pb-32 text-sm">
                ...
                <p class="w-4/5 text-xs font-bold text-justify py-1 align-middle m-0  ">
                    FIRMA DE QUIEN ENVIE Y RECIBE LOS EQUIPOS O HERRAMIENTAS:
                </p>
            </div>
            <div class="pb-28">
                                ...
                                <div>
                                    <select wire:model='selectedInput' id="countries"
                                        ...
                                        @foreach ($branches as $branch)
                                            <option wire:key="selectProject-{{ $branch->id }}"
            ...
            <div class="pt-1">
                <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 lg:py-14">
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <form class="space-y-4 md:space-y-6" wire:submit="save({{ $id }})">
