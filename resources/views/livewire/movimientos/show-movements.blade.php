<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <x-table>
        <div class="px-3 py-3 flex items-center">
            ...
            <x-input class="flex-1 mx-2" placeholder="Buscador Numero de Recibo" type="text"
                    ...
                    @foreach ($movements as $movement)
                        <tr wire:key="movement-{{ $movement->receipt_number }}">
                            ...
                            @switch($movement->state_create)
                                ...
                                @break
                            @endswitch
                            <td class="flex px-1 pt-1 text-left text-sm font-medium "
                                style="padding-top: 0.150rem;   padding-bottom: 0.150rem;">
                                @can('admin.movement.see')
                                    <div>
                                        @livewire('movimientos.view-movements', ['receipt_number' => $movement->receipt_number], key($movement->receipt_number))
                                    </div>
                                @endcan

                                @if ($movement->state_create == 0 || $movement->state_create == 1 || $movement->state_create == 2)
