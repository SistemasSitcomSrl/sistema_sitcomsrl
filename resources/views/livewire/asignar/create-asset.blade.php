<div>
    <div class="flex bg-white">
        <div class="p-2 border-4  border-slate-200 w-7/12">
            ...
            <div>
                <p class="w-full text-xs text-center font-bold py-1 align-middle m-0">
                    SOLICITUD DE ASIGNACION DE ACTIVOS</p>
            </div>
            <div class="w-full">
                <button type="button" wire:click="projectName()"
                    ...
                    DATOS A QUIEN SE LE ENTREGA LOS ACTIVOS
                </button>
            </div>
            ...
            @if ($names)
                <div class="pb-2 text-sm">
                    <div class=" border-x-4 border-t border-slate-700 grid grid-cols-12 divide-x">
                        <div class="pr-2 text-right font-bold">Carnet:</div>
                        <div class="col-span-4">{{ $names->ci }}</div>
                        <div class="text-right pr-2 font-bold">Nombre:</div>
                        <div class="col-span-2">{{ $names->name }} {{ $names->last_name }}</div>
                        <div class="text-right pr-2 font-bold">Lugar:</div>
                        <div class="col-span-3">{{ $names->ubication }}</div>
                    </div>
                    <div class=" border-x-4 border-t border-b border-slate-700 grid grid-cols-12 divide-x">
                        <div class="pr-2 text-right font-bold">Cargo:</div>
                        <div class="col-span-4">{{ $names->company_position }}</div>
                        <div class="text-right pr-2 font-bold">Celular:</div>
                        <div class="col-span-2">{{ $names->phone_number }}</div>
            ...
            <div class="w-full">
                <button type="button"
                    ...
                    DATOS DEL RESPONSABLE DE LA ENTREGA DE LOS ACTIVOS
                </button>
            </div>
            ...
            <div class="pb-16 text-sm">
                <p class="w-4/5 text-justify  py-1 align-middle m-0  ">
                    El presente compromiso aplica para el uso correcto de los activos.
                </p>

                <p class="w-4/5 text-xs font-bold text-justify py-1 align-middle m-0  ">
                    FIRMA DE QUIEN RECIBE LOS ACTIVOS:
                </p>
            </div>
            <div class="pb-8">
            ...
            <div class="text-center">
                <x-danger-button onclick="location.href='{{ route('admin.assign.index') }}'" class="mr-2">
        ...
        <div class="border-4  border-slate-200 w-5/12">
            <div class="px-2 py-2 flex items-center">
                <x-input class="flex-1 mx-2 text-xs" placeholder="Buscador Nombre del Activo" type="text"
    ...
    {{-- Inicio Modal Seleccionar Personal --}}
    @if ($openCreate)
        <div class="bg-gray-800 bg-opacity-25 fixed pt-20 inset-0 " wire:click="$set('openCreate',false)">
            <div class="max-w-xl mx-auto " wire:click.stop>
    ...
    @endif
    {{-- Fin Modal Seleccionar Personal --}}

    {{-- Inicio Modal Seleccionar Cantidad Herramienta --}}
    @if ($openImagen)
        <div class="bg-gray-800 bg-opacity-25 fixed pt-16 inset-0 " wire:click="$set('openImagen',false)">
            <div style="max-width: 52rem" class=" mx-auto " wire:click.stop>
                <div class="bg-white shadow rounded-lg p-6">
                    <div class="flex">
                        <p class="font-bold text-base align-middle m-0  ">
                    ...
                    <form class="space-y-4 md:space-y-6">
                        ...
                        <div class="text-right ">
                            ...
                            <x-secondary-button wire:click="save({{ $id }})" wire:loading.attr="disabled"
